...
import KeshuTubee from "../assets/logo-no-background.png";
import KeshuTubeeMobile from "../assets/youtube.png";
    ...
    <div className="flex flex-row h-14 px-4 md:px-5 justify-between items-center sticky top-0 z-20 bg-white dark:bg-black shadow-md">
      ...
      <div className="flex items-center">
        ...
        <div className="flex h-8 w-8 overflow-hidden rounded-full md:ml-4">
          <Link to={"https://github.com/keshavjatt"}>
            <img
              src="https://avatars.githubusercontent.com/u/120629247?v=4"
              alt="Keshav Developer"
              target="_blank"
            />
          </Link>
        </div>
